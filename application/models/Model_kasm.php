...
class Model_kasm extends CI_Model
{
    ...
    public function datakasmasuk($srnobukti, $srkodebank, $srnamabank, $srdesk, $dari, $sampai)
    {        
    ...
    public function datakasm($id)
    {
        ...
        $this->db->join('trankasm_h as h', 'h.id = d.idh', 'Left');
